...
class AdminsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'phone' => ['type' => 'integer', 'length' => 12, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-01-15 08:02:07',
            'modified' => '2017-01-15 08:02:07'
        ],
    ];
}
